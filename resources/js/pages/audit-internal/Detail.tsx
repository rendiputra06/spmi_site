...
import AuditorDocumentsTab from './components/detail/AuditorDocumentsTab';
...
type TabKey = 'standar' | 'unit' | 'laporan' | 'dokumen';
    ...
    >
      <div className="space-y-6 p-4 md:p-6">
        ...
        <div className="flex flex-wrap items-center gap-2">
          ...
          <Button variant={tab === 'dokumen' ? 'default' : 'outline'} onClick={() => setTab('dokumen')}>Dokumen Laporan</Button>
        </div>
        ...
        {tab === 'dokumen' && (
          <AuditorDocumentsTab auditor_reports={auditor_reports} unitNameById={unitNameById} />
        )}
      </div>
    </AppLayout>
  );
